...
export function generateAuditReportText(dataset: DatasetItem): string {
  ...
  return `=======================================================
PII GUARD AUDIT REPORT & COMPLIANCE VERIFICATION
=======================================================
Dataset:            ${dataset.filename}
...
Generated by PII Guard Compliance Engine
=======================================================`;
}
