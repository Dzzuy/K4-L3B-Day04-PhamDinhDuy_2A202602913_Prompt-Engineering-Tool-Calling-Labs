...
export default function SettingsPage() {
  ...
  const [model] = useState("openai/gpt-4.1-mini");
          ...
          <div className="p-5 bg-white border border-zinc-200 rounded-2xl space-y-4 shadow-xs">
            ...
            <div className="space-y-1.5">
              ...
              <input
                readOnly
                value={model}
                className="w-full px-3 py-2 text-xs font-mono bg-zinc-50 border border-zinc-300 rounded-xl text-zinc-900"
              />
              <p className="text-[11px] text-zinc-400">Provider: OpenRouter · final demo configuration</p>
            </div>
