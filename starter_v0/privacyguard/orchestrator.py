...
PRIVACY_PROMPT = ROOT / "artifacts" / "privacy_system_prompt.md"
PRIVACY_TOOLS = ROOT / "artifacts" / "privacy_tools.yaml"
...
def llm_pipeline(dataset_id: str, message: str, history: list[dict[str, str]]) -> dict[str, Any] | None:
    ...
    try:
        ...
        user_text = (
            ...
            f"{message.strip()}\n"
            "If this is a PII scan or masking preview, call scan_dataset, detect_pii, then preview_masking."
        )
        messages = [
